...
- [two-factor-authentication-demo](#two-factor-authentication-demo)
  ...
  - [Full Verification Workflow](#full-verification-workflow)
    ...
    - [2. Prepare environment files](#2-prepare-environment-files)
    - [3. Install frontend dependencies](#3-install-frontend-dependencies)
    - [4. Run backend tests](#4-run-backend-tests)
    - [5. Run frontend tests](#5-run-frontend-tests)
    ...
    - [9. Smoke test the UI flow](#9-smoke-test-the-ui-flow)
    - [10. Verify error handling](#10-verify-error-handling)
    - [11. Optional clean restart check](#11-optional-clean-restart-check)
  - [Notes](#notes)
